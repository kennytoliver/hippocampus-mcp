# -*- coding: utf-8 -*-
"""品牌改名工具：Loci / 忆宫 → Loci / 忆宫

当前覆盖**第 1 步（对外文档层）**：README.md / README_EN.md / USAGE.md / LICENSE / tools/publish.py。
后续步骤（面板界面文案、代码标识符）继续往 PLAN 里加条目即可，机制不变。

为什么要写脚本而不是满仓库 sed：
  仓库里 213 处 "hippocampus" 里，**大部分是代码标识符**（loci.py / loci.db /
  LOCI_DB / LOCI_AGENT / claude mcp add loci / loci_registered），
...
PLAN = [
    # ── README.md ──
    ("README.md", 'alt="Loci"', 'alt="Loci"', 1),
    ("README.md", "<b>I never forget.</b>", "<b>a memory palace your agents share.</b>", 1),
    ("README.md", "# Loci（忆宫）— 个人跨 Agent 记忆中枢",
                  "# Loci（忆宫）— 个人跨 Agent 记忆中枢", 1),
    ("README.md", "### Loci 的做法：", "### Loci 的做法：", 1),
    ("README.md", "Loci 把这件事做成本地的一个 SQLite 文件",
                  "Loci 把这件事做成本地的一个 SQLite 文件", 1),
    ("README.md", "哪些已接入 Loci", "哪些已接入 Loci", 1),
    ("README.md", "git clone https://github.com/<你的名字>/hippocampus.git\ncd hippocampus",
                  "git clone https://github.com/kennytoliver/loci-local.git\ncd loci-local", 1),
    ("README.md", "MIT © Loci contributors.", "MIT © Loci contributors.", 1),

    # ── README_EN.md ──
    ("README_EN.md", 'alt="Loci"', 'alt="Loci"', 1),
    ("README_EN.md", "<b>I never forget.</b>", "<b>a memory palace your agents share.</b>", 1),
    ("README_EN.md", "# Loci\n", "# Loci\n", 1),
    ("README_EN.md", "Loci fixes that:", "Loci fixes that:", 1),
    # ASCII 架构图：Loci(11 字符) → Loci(4)，补 7 个空格保持竖线对齐
    ("README_EN.md", "┼──►  Loci  ──►", "┼──►  Loci         ──►", 1),
    ("README_EN.md", "### What Loci does:", "### What Loci does:", 1),
    ("README_EN.md", "Loci keeps it in a single local SQLite file",
                    "Loci keeps it in a single local SQLite file", 1),
    ("README_EN.md", "git clone https://github.com/<you>/hippocampus.git\ncd hippocampus",
                    "git clone https://github.com/kennytoliver/loci-local.git\ncd loci-local", 1),
    ("README_EN.md", "Loci reads the conversation stores",
                    "Loci reads the conversation stores", 1),
    ("README_EN.md", "Loci writes a plain-language usage convention",
                    "Loci writes a plain-language usage convention", 1),
    ("README_EN.md", "Loci is an independent implementation",
                    "Loci is an independent implementation", 1),

    # ── USAGE.md ──
    ("USAGE.md", "# Loci 操作手册", "# Loci（忆宫）操作手册", 1),
    ("USAGE.md", "给**另一台电脑上的 Loci**", "给**另一台电脑上的 Loci**", 1),
    ("USAGE.md", "云笔记 / 云盘 | Loci |", "云笔记 / 云盘 | Loci |", 1),

    # ── LICENSE ──
    ("LICENSE", "Copyright (c) 2026 Loci contributors",
