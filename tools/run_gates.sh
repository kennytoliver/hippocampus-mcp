...
# 重型闸门：出现名字里的关键字就归为"慢"
HEAVY="audit_tokens measure_layers smoke_panel verify_link_shots verify_link_measure verify_slist_rows verify_shutdown verify_audit_perf verify_extract_perf shot_new_pages verify_content"
